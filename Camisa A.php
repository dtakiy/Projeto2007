...
<BR>
<BR>
<td><img src='camisa2.jpg'height='150' width='150' name='prod'>&nbsp &nbsp</td>
<td><table border=0>
...
<td><div align='center' style='font-size:10px;font-family:Verdana'><a href='carr.php?cod=13&acao=incluir' class='button'>Comprar</a></div><br></td>
</td>
</tr>
</table>

<div class='fb-comments' data-href='127.0.0.1/cusko/Camisa A.php' data-width='470' data-num-posts='10'></div>
...
<div class='rodape-div'><p>Loja Cusko</p></div>		
         ...
         <div class='dir-div'>								
			...
			<form id='formconsult' name='formconsult' method='post' action='consulta.php'>
      		...
      		<input name='login' type='text' id='login' placeholder='Código da Compra' size='20' maxlength='60'/>
      		<input name='btn_codcompra' class='button' type='submit' size='2' id='btn_codcompra' value='Pesquisar' />
